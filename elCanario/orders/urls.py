...
from orders.views import OrderListView, OrderCreateView, ReadDataListView, ReadDataTypeListView, OrderUpdateTemplate,OrderUpdateView, order_delete
# from orders.views import OrderCreateTemplate
app_name = 'orders'
urlpatterns = [
