...
from orders.views import OrderListView, OrderCreateView, ReadDataListView, ReadDataTypeListView,OrderUpdateView, order_delete
# from orders.views import OrderCreateTemplate, OrderUpdateTemplate
app_name = 'orders'
urlpatterns = [
