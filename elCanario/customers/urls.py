...
from customers.views import CustomerListView, ReadDataListView, CustomerCreateView, ReadDataTypeListView,CustomerUpdateView, CustomerUpdateTemplate
...
urlpatterns = [
    ...
    path('updatetemp/<int:pk>/', CustomerUpdateTemplate.as_view(), name="update-template"),
